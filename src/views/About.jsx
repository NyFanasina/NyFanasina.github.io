import { BiLogoTypescript, BiLogoJavascript, BiLogoReact, BiLogoTailwindCss, BiLogoBootstrap, BiLogoPhp, BiLogoGit, BiLogoGithub } from "react-icons/bi";
  ...
  return (
    <div className="sm:py-20 py-10 text-center" id="about">
      <div>
        ...
        <p>Moi, c'est Ny Fanasina, étudiant en informatique et développeur logiciel spécialisé dans le développement web et mobile.</p>
      ...
      <div className="py-10 justify-around flex-wrap">
        ...
        <TechItemAbout title="Frameworks et Librairies">
          <BiLogoReact color="#61d9ee" size={49} tooltip="React.js" />
          <TbBrandReactNative color="#4c76af" size={45} tooltip="React Native" />
          <RiNextjsFill size={49} color="black" tooltip="Next.js" enableBackground={5} className="bg-white rounded-lg" />
          <SiExpress color="#eeeeee" size={51} tooltip="Express.js" />
          <SiLaravel color="red" size={44} tooltip="Laravel" className="mt-1" />
        </TechItemAbout>
